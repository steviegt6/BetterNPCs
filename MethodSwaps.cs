...
namespace BetterNPCs
{
    ...
    {
        private Color goldenColor = Color.White;
        ...
        private void Main_GUIChatDrawInner(On.Terraria.Main.orig_GUIChatDrawInner orig, Main self)
        {
            if (player[myPlayer].talkNPC >= 0 || player[myPlayer].sign != -1)
            {
                ...
                List<List<TextSnippet>> snippets = Utils.WordwrapStringSmart(npcChatText, Color.White, fontMouseText, 440, 10);
                ...
                //NPCHappinessSystem globalNPC = new NPCHappinessSystem();
                //Texture2D happinessMeterBack = ModContent.GetTexture("BetterNPCs/Content/UI/HappinessMeter_Back");
                Texture2D happinessMeterFront = ModContent.GetTexture("BetterNPCs/Content/UI/HappinessMeter_Front");
                ...
                {
                    //spriteBatch.Draw(happinessMeterBack, new Vector2((screenWidth / 2 - happinessMeterBack.Width / 2) - 215, 100f - 36f), new Rectangle(0, 0, happinessMeterBack.Width, happinessMeterBack.Height), color, 0f, default, 1f, SpriteEffects.None, 0f);

                    spriteBatch.Draw(happinessMeterFront, new Vector2((screenWidth / 2 - happinessMeterFront.Width / 2) - 220, 100f - 30f), new Rectangle(0, 0, happinessMeterFront.Width, happinessMeterFront.Height), color, 0f, default, 1f, SpriteEffects.None, 0f);

                    ChatManager.DrawColorCodedStringWithShadow(spriteBatch, fontMouseText, npc[player[myPlayer].talkNPC].FullName, new Vector2((screenWidth / 2 - 190), 100f - 22f), goldenColor, 0f, Vector2.Zero, Vector2.One);
                }
                ...
                int focusTextNPC = player[myPlayer].talkNPC > 0 ? npc[player[myPlayer].talkNPC].type : 0;
                ...
                {
                    focusText3 = (!editSign) ? GetLegacyInterfaceText(48).Value : GetLegacyInterfaceText(47).Value;
                }
                else if (npc[player[myPlayer].talkNPC].type == NPCID.Dryad)
                {
                    focusText4 = "Status";
                    focusText3 = GetLegacyInterfaceText(28).Value;
                    focusText2 = "World " + GetLegacyInterfaceText(49).Value;
                }
                else if (npc[player[myPlayer].talkNPC].type == NPCID.DyeTrader)
                {
                    focusText4 = "Status";
                    focusText3 = GetLegacyInterfaceText(28).Value;
                    focusText2 = GetLegacyInterfaceText(107).Value;
                }
                ...
                {
                    focusText2 = "Status";
                    focusText3 = GetLegacyInterfaceText(64).Value;
                }
                else if (npc[player[myPlayer].talkNPC].type == NPCID.Merchant || npc[player[myPlayer].talkNPC].type == NPCID.ArmsDealer || npc[player[myPlayer].talkNPC].type == NPCID.Demolitionist || npc[player[myPlayer].talkNPC].type == NPCID.Clothier || npc[player[myPlayer].talkNPC].type == NPCID.GoblinTinkerer || npc[player[myPlayer].talkNPC].type == NPCID.Wizard || npc[player[myPlayer].talkNPC].type == NPCID.Mechanic || npc[player[myPlayer].talkNPC].type == NPCID.SantaClaus || npc[player[myPlayer].talkNPC].type == NPCID.Truffle || npc[player[myPlayer].talkNPC].type == NPCID.Steampunker || npc[player[myPlayer].talkNPC].type == NPCID.DyeTrader || npc[player[myPlayer].talkNPC].type == NPCID.PartyGirl || npc[player[myPlayer].talkNPC].type == NPCID.Cyborg || npc[player[myPlayer].talkNPC].type == NPCID.Painter || npc[player[myPlayer].talkNPC].type == NPCID.WitchDoctor || npc[player[myPlayer].talkNPC].type == NPCID.Pirate)
                {
                    ...
                    {
                        focusText2 = GetLegacyInterfaceText(19).Value;
                        focusText4 = "Status";
                    }
                    else
                    {
                ...
                else if (npc[player[myPlayer].talkNPC].type == NPCID.OldMan)
                {
                    if (!dayTime)
                    {
                        focusText3 = GetLegacyInterfaceText(50).Value;
                    }
                }
                else if (npc[player[myPlayer].talkNPC].type == NPCID.Guide)
                {
                    focusText5 = "Status";
                    focusText4 = "Shop";
                    focusText3 = GetLegacyInterfaceText(51).Value;
                    focusText2 = GetLegacyInterfaceText(25).Value;
                }
                else if (npc[player[myPlayer].talkNPC].type == NPCID.TaxCollector)
                {
                    ...
                    {
                        focusText3 = GetLegacyInterfaceText(89).Value;
                    }
                    else
                    {
                        string text5 = "";
                        ...
                        if (num26 > 0)
                        {
                            text5 = text5 + num26.ToString() + " " + GetLegacyInterfaceText(15).Value + " ";
                        }

                        if (num25 > 0)
                        {
                            text5 = text5 + num25.ToString() + " " + GetLegacyInterfaceText(16).Value + " ";
                        }

                        if (num24 > 0)
                        {
                            text5 = text5 + num24.ToString() + " " + GetLegacyInterfaceText(27).Value + " ";
                        }

                        if (num23 > 0)
                        {
                            text5 = text5 + num23.ToString() + " " + GetLegacyInterfaceText(18).Value + " ";
                        }
                        ...
                        if (num26 > 0)
                        {
                            textColor2 = new Color((byte)(220f * num21), (byte)(220f * num21), (byte)(198f * num21), mouseTextColor);
                        }
                        else if (num25 > 0)
                        {
                            textColor2 = new Color((byte)(224f * num21), (byte)(201f * num21), (byte)(92f * num21), mouseTextColor);
                        }
                        else if (num24 > 0)
                        {
                            textColor2 = new Color((byte)(181f * num21), (byte)(192f * num21), (byte)(193f * num21), mouseTextColor);
                        }
                        else if (num23 > 0)
                        {
                            textColor2 = new Color((byte)(246f * num21), (byte)(138f * num21), (byte)(96f * num21), mouseTextColor);
                        }
                        ...
                        else
                        {
                            ...
                            focusText3 = GetLegacyInterfaceText(89).Value + " (" + text5 + ")";
                        }
                    }
                }
                else if (npc[player[myPlayer].talkNPC].type == NPCID.Nurse)
                {
                    ...
                    if (num20 > 0)
                    {
                        text3 = text3 + num20.ToString() + " " + GetLegacyInterfaceText(15).Value + " ";
                    }

                    if (num19 > 0)
                    {
                        text3 = text3 + num19.ToString() + " " + GetLegacyInterfaceText(16).Value + " ";
                    }

                    if (num18 > 0)
                    {
                        text3 = text3 + num18.ToString() + " " + GetLegacyInterfaceText(17).Value + " ";
                    }

                    if (num17 > 0)
                    {
                        text3 = text3 + num17.ToString() + " " + GetLegacyInterfaceText(18).Value + " ";
                    }
                    ...
                    if (num20 > 0)
                    {
                        textColor2 = new Color((byte)(220f * num15), (byte)(220f * num15), (byte)(198f * num15), mouseTextColor);
                    }
                    else if (num19 > 0)
                    {
                        textColor2 = new Color((byte)(224f * num15), (byte)(201f * num15), (byte)(92f * num15), mouseTextColor);
                    }
                    else if (num18 > 0)
                    {
                        textColor2 = new Color((byte)(181f * num15), (byte)(192f * num15), (byte)(193f * num15), mouseTextColor);
                    }
                    else if (num17 > 0)
                    {
                        textColor2 = new Color((byte)(246f * num15), (byte)(138f * num15), (byte)(96f * num15), mouseTextColor);
                    }

                    if (text3 == "")
                    {
                        focusText3 = GetLegacyInterfaceText(54).Value;
                    }
                    else
                    {
                        text3 = text3.Substring(0, text3.Length - 1);
                        focusText3 = GetLegacyInterfaceText(54).Value + " (" + text3 + ")";
                    }
                ...
                if (!flag3)
                {
                    goldenColor = textColor2;
                    DrawNPCChatButtons(num32, textColor2, lineAmount, focusText3, focusText2, focusText4, focusText5, focusTextNPC);
                }
                ...
                if (!mouseLeft || !mouseLeftRelease || !rectangle.Contains(new Point(mouseX, mouseY)))
                {
                    return;
                }
                    ...
                    else
                    {
                        ...
                        else if (npc[player[myPlayer].talkNPC].type == NPCID.TaxCollector)
                        {
                            if (player[myPlayer].taxMoney > 0)
                            {
                                ...
                                npcChatText = GetNPCDialog(rand.Next(380, 382));
                                player[myPlayer].taxMoney = 0;
                            }
                            else
                            {
                                npcChatText = GetNPCDialog(rand.Next(390, 401));
                            }
                        }
                        else if (npc[player[myPlayer].talkNPC].type == NPCID.Nurse)
                        {
                            ...
                            if (num27 > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (num33 == 0)
                                    {
                                        npcChatText = GetNPCDialog(52);
                                    }
                                    if (num33 == 1)
                                    {
                                        npcChatText = GetNPCDialog(53);
                                    }
                                    if (num33 == 2)
                                    {
                                        npcChatText = GetNPCDialog(54);
                                    }
                                }
                            }
                            else
                            {
                                ...
                                {
                                    case 0:
                                        npcChatText = GetNPCDialog(55);
                                        break;

                                    case 1:
                                        npcChatText = GetNPCDialog(56);
                                        break;

                                    case 2:
                                        npcChatText = GetNPCDialog(57);
                                        break;
                                }
                            }
                        }
        ...
        private static void DrawNPCChatButtons(int superColor, Color chatColor, int numLines, string focusText, string focusText3, string focusText4, string focusText5, int focusTextNPC)
        {
            ...
            text3 = GetLegacyInterfaceText(52).Value;
            font3 = fontMouseText;
            vector9 = vector7;
            ...
            Vector2 vector12 = new Vector2(vector11.X + stringSize3.X * value.X + 30f, y);

            if (string.IsNullOrWhiteSpace(focusText4) || focusTextNPC == 0)
            {
                return;
            }
            ...
            if (npcChatFocus4 && mouseLeft && mouseLeftRelease)
            {
                BetterNPCsGlobalNPC.NewButtonsClicked(focusTextNPC, false);
            }

            ChatManager.DrawColorCodedStringWithShadow(spriteBatch, font3, text3, vector9 + stringSize3 * value * 0.5f, baseColor3, 0f, stringSize3 * 0.5f, vector8 * value);
            Vector2 vector13 = new Vector2(vector12.X + stringSize3.X * value.X + 30f, y);

            if (string.IsNullOrWhiteSpace(focusText5) || focusTextNPC == 0)
            {
                return;
            }
            ...
            if (npcChatFocus5 && mouseLeft && mouseLeftRelease)
            {
                BetterNPCsGlobalNPC.NewButtonsClicked(focusTextNPC, true);
            }
        ...
        {
            bool flag35 = false; //Holy crap, Red.
            bool flag34 = false;
            bool flag33 = true;
            bool flag32 = false;
            bool flag31 = false;
            ...
            for (int j = 0; j < 58; j++)
            {
                if ((player[myPlayer].inventory[j].pick > 0 && player[myPlayer].inventory[j].Name != "Copper Pickaxe") || (player[myPlayer].inventory[j].axe > 0 && player[myPlayer].inventory[j].Name != "Copper Axe") || player[myPlayer].inventory[j].hammer > 0)
                {
                    flag33 = false;
                }
            ...
            while (true)
            {
                ...
                if (flag33)
                {
                    if (helpText == 1)
                    {
                        npcChatText = GetNPCDialog(177);
                        return;
                    }

                    if (helpText == 2)
                    {
                        npcChatText = GetNPCDialog(178);
                        return;
                    }

                    if (helpText == 3)
                    {
                        npcChatText = GetNPCDialog(179);
                        return;
                    }

                    if (helpText == 4)
                    {
                        npcChatText = GetNPCDialog(180);
                        return;
                    }

                    if (helpText == 5)
                    {
                        npcChatText = GetNPCDialog(181);
                        return;
                    }

                    if (helpText == 6)
                    {
                        npcChatText = GetNPCDialog(182);
                        return;
                    }
                }
                ...
                if (flag33 && flag32 && !flag31)
                {
                    if (helpText == 21)
                    {
                        npcChatText = GetNPCDialog(184);
                        return;
                    }

                    if (helpText == 22)
                    {
                        npcChatText = GetNPCDialog(185);
                        return;
                    }
                }
                ...
                if (flag33 && flag31)
                {
                    if (helpText == 31)
                    {
                        npcChatText = GetNPCDialog(186);
                        return;
                    }
                    if (helpText == 32)
                    {
                        npcChatText = GetNPCDialog(187);
                        return;
                    }
                }
                ...
                {
                    npcChatText = GetNPCDialog(188);
                    return;
                }

                if (!flag34 && helpText == 42)
                {
                    npcChatText = GetNPCDialog(189);
                    return;
                }

                if (!flag34 && !flag30 && helpText == 43)
                {
                    npcChatText = GetNPCDialog(190);
                    return;
                }
                ...
                if (!flag26 && !flag25)
                {
                    if (helpText == 51)
                    {
                        npcChatText = GetNPCDialog(191);
                        return;
                    }

                    if (helpText == 52)
                    {
                        npcChatText = GetNPCDialog(192);
                        return;
                    }

                    if (helpText == 53)
                    {
                        npcChatText = GetNPCDialog(193);
                        return;
                    }

                    if (helpText == 54)
                    {
                        npcChatText = GetNPCDialog(194);
                        return;
                    }
                }
                ...
                {
                    npcChatText = GetNPCDialog(195);
                    return;
                }

                if (!flag25 && helpText == 62)
                {
                    npcChatText = GetNPCDialog(196);
                    return;
                }

                if (!flag23 && helpText == 63)
                {
                    npcChatText = GetNPCDialog(197);
                    return;
                }

                if (!flag24 && helpText == 64)
                {
                    npcChatText = GetNPCDialog(198);
                    return;
                }

                if (!flag21 && helpText == 65 && NPC.downedBoss3)
                {
                    npcChatText = GetNPCDialog(199);
                    return;
                }

                if (!flag18 && helpText == 66 && NPC.downedBoss3)
                {
                    npcChatText = GetNPCDialog(200);
                    return;
                }

                if (!flag22 && helpText == 67)
                {
                    npcChatText = GetNPCDialog(201);
                    return;
                }

                if (!flag19 && NPC.downedBoss2 && helpText == 68)
                {
                    npcChatText = GetNPCDialog(202);
                    return;
                }

                if (!flag20 && hardMode && helpText == 69)
                {
                    npcChatText = GetNPCDialog(203);
                    return;
                }

                if (flag29 && helpText == 71)
                {
                    npcChatText = GetNPCDialog(204);
                    return;
                }

                if (flag28 && helpText == 72)
                {
                    npcChatText = GetNPCDialog(WorldGen.crimson ? 403 : 205);
                    return;
                }

                if ((flag29 | flag28) && helpText == 80)
                {
                    npcChatText = GetNPCDialog(WorldGen.crimson ? 402 : 206);
                    return;
                }

                if (!flag27 && helpText == 201 && !hardMode && !NPC.downedBoss3 && !NPC.downedBoss2)
                {
                    npcChatText = GetNPCDialog(207);
                    return;
                }

                if (helpText == 1000 && !NPC.downedBoss1 && !NPC.downedBoss2)
                {
                    npcChatText = GetNPCDialog(208);
                    return;
                }

                if (helpText == 1001 && !NPC.downedBoss1 && !NPC.downedBoss2)
                {
                    npcChatText = GetNPCDialog(209);
                    return;
                }
                ...
                if (helpText == 1002 && !NPC.downedBoss2)
                {
                    if (WorldGen.crimson)
                    {
                        npcChatText = GetNPCDialog(331);
                    }
                    else
                    {
                        npcChatText = GetNPCDialog(210);
                    }
